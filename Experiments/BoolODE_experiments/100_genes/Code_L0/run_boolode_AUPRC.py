...
if __name__ == "__main__":
    ...
    if not os.path.isfile(error_metrics_filename):
        with open(error_metrics_filename, 'w') as f:
            f.write('t,p,n,nu_0,mu,gamma,no_edges,bic value,precision_avg,recall_avg,F1_avg,Time(sec),mask_diag')
            f.write('\n')
    
    W = np.eye(10)
    edges = [(0, 4), (4, 9), (8, 9), (2, 8), (5, 8), (1, 5), (3, 9), (3, 7), (3, 6)]
    for i, j in edges:
        W[i, j] = 1
    W=np.triu(W,1)
