...
# Output file paths
direct_outfile1 = os.path.join(output_dir, "Direct_results1.csv")
cat_outfile1 = os.path.join(output_dir, "Cat_results1.csv")
direct_outfile2 = os.path.join(output_dir, "Direct_results2.csv")
cat_outfile2 = os.path.join(output_dir, "Cat_results2.csv")
