...
for input_file, output_file in files:
    ...
    # Group by 'perturb_strength' and average numeric columns
    # This will average over all 'rd_seed' values for each 'perturb_strength'
    avg_df = df.groupby('perturb_strength', as_index=False).mean()
